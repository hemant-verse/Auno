      ...
      <header className="sticky top-0 z-30 bg-white/80 backdrop-blur-md border-b border-zinc-200/80">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <span className="text-xs font-bold uppercase tracking-wider text-zinc-400">Saved Items</span>
          </div>
          ...
          <div className="flex items-center gap-3">
            <Link
              ...
              className="p-2 text-rose-600 bg-rose-50 rounded-full transition-colors relative"
            >
